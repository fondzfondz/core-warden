...
const PATH_ARCHIVES = {
  Astronomy: {
    ...
    sequences: [
      ...
      [2, "เจ้าแห่งดาราโลก", "WORLD STAR LORD", "เครือข่ายดาราระดับภูมิภาค / ควบคุมดาราทั้งฟ้า / Stellar Descent", "Regional Star Node network / command the sky of stars / Stellar Descent", "เปิดเผยพลังที่ถูกซ่อน มองเห็นการไหลเวียนของอำนาจ รบกวนคำสาปและอาคมระดับสูง และเจาะทะลุการปกปิดที่อ่อนแอกว่า", "Reveal hidden powers, perceive the flow of authority, disrupt high-level curses and rituals, and pierce weaker concealment."],
      [1, "เทพแห่งดารา", "PRIMORDIAL STAR DEITY", "ทุกจุดคือ Star Node / Cosmic Traverse / Eternal Return", "Every point may become a Star Node / Cosmic Traverse / Eternal Return", "ทำลายต้นกำเนิดของคำสาป ตัดขาดการคงอยู่ของอาคม บั่นทอนพลังของศัตรูในอาณาเขต และเผาผลาญแนวคิดที่อ่อนแอกว่า", "Cut power connection points, separate abilities from their source, and destabilize power"],
    ],
